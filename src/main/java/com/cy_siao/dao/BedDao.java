...
public class BedDao {
    ...
    /**
     * The default constructor - initializes the database utility
     */
    public BedDao() {
     ...
     *
     * @return A List containing all Bed objects in the database, or an empty list if no beds exist
    ...
    /**
     * Counts the total number of beds in the database.
     *
     * @return The total number of beds, returns 0 if an error occurs during counting
     */
     ...
     *
     * @param bed The Bed object containing the updated information including:
     *            - whether the bed is double or single (determines nbPlacesMax)
     *            - the ID of the associated room (IdRoom)
     *            - the unique ID of the bed (Id) to locate the record
     */
    ...
    //Helper method to create a Bed object from a ResultSet
